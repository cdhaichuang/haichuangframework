...
public interface BaseService<T extends BaseDO> extends IService<T> {
     ...
     * @since 1.1.0.211021
     */
    default long countByIdAndIgnore(@Nullable Long id) {
        if (id == null) {
            return 0;
        }
     ...
     * @since 1.1.0.211021
     */
    default long countByIdAndIgnore(@Nullable Collection<Long> ids) {
        if (ids == null || ids.isEmpty()) {
            return 0;
        }
     ...
     * @since 1.1.0.211021
     */
    default long countByIdAndValidate(@Nullable Long id) throws MybatisServiceApplication {
     ...
     * @since 1.1.0.211021
     */
    default long countByIdAndValidate(@Nullable Long id, @Nullable String errorUserTip) throws MybatisServiceApplication {
        if (id == null) {
            throw new MybatisServiceApplication(MybatisServiceErrorEnum.ID_IS_NULL, errorUserTip);
        }
        return this.count(new QueryWrapper<T>().select(BaseDO.ID).eq(BaseDO.ID, id));
     ...
     * @since 1.1.0.211021
     */
    default long countByIdAndValidate(@Nullable Collection<Long> ids) throws MybatisServiceApplication {
     ...
     * @since 1.1.0.211021
     */
    default long countByIdAndValidate(@Nullable Collection<Long> ids, @Nullable String errorUserTip)
            throws MybatisServiceApplication {
        if (ids == null || ids.isEmpty()) {
            throw new MybatisServiceApplication(MybatisServiceErrorEnum.ID_IS_NULL, errorUserTip);
        }
