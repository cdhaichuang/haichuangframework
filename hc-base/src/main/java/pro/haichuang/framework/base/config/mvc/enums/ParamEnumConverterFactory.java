 ...
 * 请求枚举转换工厂
 *
 * <p>该类为处理 {@code Jackson} 请求参数中的枚举对应值和枚举对象进行相互转换而存在</p>
 ...
 * 因此需要用到请求参数自定转换为枚举时必须保证请求参数值类型为 {@code String} , 转换的枚举必须实现 {@link BaseEnum} 接口</p>
 * <p>对于请求体自动解析需要在枚举对象中加上下列代码实现, 代码示例:</p>
 * <pre>
